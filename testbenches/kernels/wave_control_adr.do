...
add wave -noupdate -expand -group Testbench -radix unsigned /control_conv_tb/g_tiles_y
add wave -noupdate -expand -group Testbench -radix unsigned /control_conv_tb/g_columns_last_tile_y
