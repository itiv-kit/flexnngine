...
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/r_start_init_control
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/w_status_control
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/r_start_adr
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/w_status_if
...
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_full_iact_f
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_empty_wght_f
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_full_wght_f
...
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_full_iact_address_f
...
add wave -noupdate -expand -group Start -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_full_wght_address_f

add wave -noupdate -expand -group Control_static -radix unsigned  /kernels_tb/accelerator_inst/control_inst/r_h2
#add wave -noupdate -expand -group Control_static -radix unsigned /kernels_tb/accelerator_inst/control_inst/r_tiles_y_last_tile_rows
add wave -noupdate -expand -group Control_static -radix unsigned  /kernels_tb/accelerator_inst/control_inst/r_w1
add wave -noupdate -expand -group Control_static -radix unsigned  /kernels_tb/accelerator_inst/control_inst/r_c1
add wave -noupdate -expand -group Control_static -radix unsigned  /kernels_tb/accelerator_inst/control_inst/r_c0w0
add wave -noupdate -expand -group Control_static -radix unsigned  /kernels_tb/accelerator_inst/control_inst/r_c0w0_last_c1
...
add wave -noupdate -expand -group Scratchpad -radix unsigned  /kernels_tb/accelerator_inst/w_dout_iact
add wave -noupdate -expand -group Scratchpad -radix unsigned  /kernels_tb/accelerator_inst/w_dout_iact_valid
add wave -noupdate -expand -group Scratchpad -radix unsigned  /kernels_tb/accelerator_inst/w_read_en_iact
add wave -noupdate -expand -group Scratchpad -radix unsigned  /kernels_tb/accelerator_inst/w_dout_wght
#add wave -noupdate -expand -group Scratchpad -radix decimal  /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_iact/ram_instance
#add wave -noupdate -expand -group Scratchpad -radix decimal  /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_wght/ram_instance

add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/fifo_iact(0)/fifo_iact/din
add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/fifo_iact(0)/fifo_iact/dout
add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/fifo_iact(0)/fifo_iact/valid
add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/fifo_iact(0)/fifo_iact/empty
add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_demux_iact_out_valid(0)
add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_demux_iact_out(0)
add wave -noupdate -expand -group FIFO_iact -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_dout_iact_f(0)

add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/FIFO_iact_address(0)/FIFO_iact_address/din
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/FIFO_iact_address(0)/FIFO_iact_address/dout
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/FIFO_iact_address(0)/FIFO_iact_address/valid
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/FIFO_iact_address(0)/FIFO_iact_address/empty
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/FIFO_iact_address(0)/FIFO_iact_address/full
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_full_iact_address_f
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/w_empty_iact_address_f
add wave -noupdate -expand -group FIFO_iact_address -radix unsigned /kernels_tb/accelerator_inst/scratchpad_interface_inst/o_fifo_iact_address_full

add wave -noupdate -expand -group RAM_ADR -radix unsigned /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_iact/addra
add wave -noupdate -expand -group RAM_ADR -radix unsigned /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_iact/addrb
add wave -noupdate -expand -group RAM_ADR -radix unsigned /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_wght/addra
add wave -noupdate -expand -group RAM_ADR -radix unsigned /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_wght/addrb
add wave -noupdate -expand -group RAM_ADR -radix unsigned /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_psum/addra
add wave -noupdate -expand -group RAM_ADR -radix unsigned /kernels_tb/accelerator_inst/scratchpad_inst/ram_dp_psum/addrb


add wave -noupdate -expand -group ADR_iact -radix unsigned /kernels_tb/accelerator_inst/address_generator_inst/w_address_iact_valid
...
add wave -noupdate -expand -group ADR_iact -radix unsigned /kernels_tb/accelerator_inst/address_generator_inst/w_address_iact_valid(0)
...
add wave -noupdate -expand -group ADR_wght -radix unsigned /kernels_tb/accelerator_inst/address_generator_inst/w_address_wght_valid(0)
...
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_north/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_north/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_north/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_north/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(1)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(1)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(1)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(1)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(2)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(2)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(2)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(2)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(3)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(3)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(3)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(3)/pe_inst_x(0)/pe_middle/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_north/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_north/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_north/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_north/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_north/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_north/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_north/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_north/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(3)/pe_north/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(3)/pe_north/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(3)/pe_north/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(3)/pe_north/pe_inst/line_buffer_wght/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(4)/pe_north/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(4)/pe_north/pe_inst/line_buffer_iact/i_read_offset
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(4)/pe_north/pe_inst/line_buffer_wght/r_fill_count
add wave -noupdate -expand -group Fill_Counts -radix decimal /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(0)/pe_inst_x(4)/pe_north/pe_inst/line_buffer_wght/i_read_offset
...
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix unsigned /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/i_data_in_psum_valid
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix unsigned /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/r_sel_mult_psum
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix unsigned /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/i_update_offset_psum
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/w_data_acc_out
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/w_data_acc_in1
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/w_data_acc_in2
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix unsigned /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/w_data_acc_in1_valid
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix unsigned /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/w_data_acc_in2_valid
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_psum/i_update_val
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_psum/i_update_offset
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_psum/i_command
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_psum/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_psum/r_fill_count
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_iact/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix unsigned /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_iact/r_fill_count
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_wght/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_wght/i_data
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_wght/i_data_valid
add wave -noupdate -expand -group RAM_internal -expand -group PE_4_0 -radix decimal  /kernels_tb/accelerator_inst/pe_array_inst/pe_inst_y(4)/pe_inst_x(0)/pe_south/pe_inst/line_buffer_wght/i_command
