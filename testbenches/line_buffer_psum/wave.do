...
add wave -noupdate -expand -group {Line_Buffer Input} /line_buffer_psum_tb/line_buffer_inst/r_buffer_full_wr
...
add wave -noupdate -expand -group Line_Buffer_internal /line_buffer_psum_tb/line_buffer_inst/o_buffer_full_next
...
add wave -noupdate -expand -group Line_Buffer_internal /line_buffer_psum_tb/line_buffer_inst/r_fill_count
