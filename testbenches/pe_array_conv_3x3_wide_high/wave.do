...
add wave -noupdate -expand -group {Line_Buffer Data out} -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_inst/line_buffer_iact/data_out
add wave -noupdate -expand -group {Line_Buffer Data out} -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_inst/line_buffer_iact/data_out_valid
...
add wave -noupdate -expand -group {Line_Buffer Data out} -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_inst/line_buffer_wght/data_out
add wave -noupdate -expand -group {Line_Buffer Data out} -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(0)/pe_inst/line_buffer_wght/data_out_valid
...
add wave -noupdate -expand -group RAM_internal -group PE_0_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_inst/sel_mult_psum
add wave -noupdate -expand -group RAM_internal -group PE_0_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_inst/line_buffer_iact/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_0_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_inst/line_buffer_psum/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_0_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(1)/pe_inst/line_buffer_wght/ram/ram_instance
...
add wave -noupdate -expand -group RAM_internal -group PE_2_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(1)/pe_inst/sel_mult_psum
add wave -noupdate -expand -group RAM_internal -group PE_2_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(1)/pe_inst/line_buffer_iact/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_2_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(1)/pe_inst/line_buffer_psum/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_2_1 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(1)/pe_inst/line_buffer_wght/ram/ram_instance

add wave -noupdate -expand -group RAM_internal -group PE_0_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_inst/sel_mult_psum
add wave -noupdate -expand -group RAM_internal -group PE_0_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_inst/line_buffer_iact/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_0_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_inst/line_buffer_psum/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_0_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(0)/pe_inst_x(2)/pe_inst/line_buffer_wght/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_1_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(1)/pe_inst_x(2)/pe_inst/sel_mult_psum
add wave -noupdate -expand -group RAM_internal -group PE_1_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(1)/pe_inst_x(2)/pe_inst/line_buffer_iact/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_1_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(1)/pe_inst_x(2)/pe_inst/line_buffer_psum/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_1_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(1)/pe_inst_x(2)/pe_inst/line_buffer_wght/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_2_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(2)/pe_inst/sel_mult_psum
add wave -noupdate -expand -group RAM_internal -group PE_2_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(2)/pe_inst/line_buffer_iact/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_2_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(2)/pe_inst/line_buffer_psum/ram/ram_instance
add wave -noupdate -expand -group RAM_internal -group PE_2_2 -radix unsigned /pe_array_conv_3x3_tb/pe_array_inst/pe_inst_y(2)/pe_inst_x(2)/pe_inst/line_buffer_wght/ram/ram_instance
