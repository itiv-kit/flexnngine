...
proc get_pe_path {x y} {
    ...
    return "/pe_array_conv_3x3_wide_tb/pe_array_inst/pe_inst_y(${y})/pe_inst_x(${x})/${pe_name}/pe_inst"
}
...
add wave -noupdate -expand -group Testbench -radix unsigned /pe_array_conv_3x3_wide_tb/s_done
