...
add wave -noupdate -expand -group internal -radix symbolic /address_generator_tb/dut/r_iact_done
...
add wave -noupdate -group {tb mem read} -radix symbolic /address_generator_tb/fifo_empty
add wave -noupdate -group {tb mem read} -radix symbolic /address_generator_tb/fifo_rd
add wave -noupdate -group {tb mem read} /address_generator_tb/fifo_rd_delay
add wave -noupdate -group {tb mem read} -radix unsigned /address_generator_tb/fifo_dout
add wave -noupdate -group {tb mem read} /address_generator_tb/mem_rsh_en
add wave -noupdate -group {tb mem read} -radix unsigned /address_generator_tb/mem_rsh_addr
add wave -noupdate -group {tb mem read} /address_generator_tb/mem_rsh_dout
add wave -noupdate -group {tb mem read} /address_generator_tb/row_read
...
add wave -noupdate -expand -group verify -radix unsigned -childformat {{/address_generator_tb/verify/row_cnt(0) -radix unsigned} {/address_generator_tb/verify/row_cnt(1) -radix unsigned} {/address_generator_tb/verify/row_cnt(2) -radix unsigned} {/address_generator_tb/verify/row_cnt(3) -radix unsigned} {/address_generator_tb/verify/row_cnt(4) -radix unsigned} {/address_generator_tb/verify/row_cnt(5) -radix unsigned} {/address_generator_tb/verify/row_cnt(6) -radix unsigned} {/address_generator_tb/verify/row_cnt(7) -radix unsigned} {/address_generator_tb/verify/row_cnt(8) -radix unsigned}} -subitemconfig {/address_generator_tb/verify/row_cnt(0) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(1) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(2) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(3) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(4) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(5) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(6) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(7) {-height 16 -radix unsigned} /address_generator_tb/verify/row_cnt(8) {-height 16 -radix unsigned}} /address_generator_tb/verify/row_cnt
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {11137 ns} 0}
