...
add wave -noupdate -expand -group Scratchpad -radix unsigned /control_conv_tb/scratchpad_inst/dout_iact
add wave -noupdate -expand -group Scratchpad -radix unsigned /control_conv_tb/scratchpad_inst/dout_wght

add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_C0_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_count_c0_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_W1
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_count_w1_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_C1
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_count_c1_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_H2
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_count_h2_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_offset_c_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_offset_c_last_c1_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_offset_c_last_h2_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_index_c_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_index_c_last_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/r_data_valid_iact
add wave -noupdate -expand -group ADR_iact -radix unsigned /control_conv_tb/address_generator_inst/o_buffer_full_iact

add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_C0_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_count_c0_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_W1
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_count_w1_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_C1
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_count_c1_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_H2
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_count_h2_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_offset_c_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_offset_c_last_c1_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_offset_c_last_h2_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_index_c_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_index_c_last_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/r_data_valid_wght
add wave -noupdate -expand -group ADR_wght -radix unsigned /control_conv_tb/address_generator_inst/o_buffer_full_wght

add wave -noupdate -expand -group FIFO_iact -radix unsigned /control_conv_tb/fifo_din
add wave -noupdate -expand -group FIFO_iact -radix unsigned /control_conv_tb/fifo_dout
add wave -noupdate -expand -group FIFO_iact -radix unsigned /control_conv_tb/fifo_valid
add wave -noupdate -expand -group FIFO_iact -radix unsigned /control_conv_tb/fifo_empty
add wave -noupdate -expand -group FIFO_iact -radix unsigned /control_conv_tb/mult_out
